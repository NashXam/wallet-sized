...
namespace WalletSized.iOS
{
	public partial class MasterViewController : UITableViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			dataSource.Objects.Add ("0");
			dataSource.Objects.Add ("1");
			dataSource.Objects.Add ("2");
			dataSource.Objects.Add ("3");
			dataSource.Objects.Add ("4");
			dataSource.Objects.Add ("5");
			dataSource.Objects.Add ("6");
			dataSource.Objects.Add ("7");
			dataSource.Objects.Add ("8");
			dataSource.Objects.Add ("9");
		}
